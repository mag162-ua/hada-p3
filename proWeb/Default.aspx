...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="content">
         ...
         <asp:RequiredFieldValidator ControlToValidate="Price" ErrorMessage="Price is required" runat="server" ForeColor="Red" ValidationGroup="UpdateValidation" />
            &nbsp
         <asp:RegularExpressionValidator ControlToValidate="Price" ValidationExpression="^\d{1,4}(\,\d{1,2})?$" ErrorMessage="(Use ,) Price must be between 0 and 9999,99 " runat="server" ForeColor="Red" ValidationGroup="UpdateValidation" /> 
         <br />
         <br />
         Creation Date&nbsp;&nbsp;&nbsp;&nbsp;
